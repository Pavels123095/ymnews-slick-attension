<?php 
class Ym_slick_footer extends WP_Widget {
 ...
 function __construct() {
     parent::__construct(
         'Ym_slick_footer', 
         'Вывод рекламы в подвале', // заголовок виджета
         array( 'description' => 'Вывод рекламных баннеров для подвала' ) // описание
     );
 }
         /*
         * фронтэнд виджета
                 ...
                 echo $args['before_title'] . $title . $args['after_title'];
                     ...
                     <?php 
                             if ($atten->have_posts()):
                                 ...
                                 $keys = get_post_meta($id, 'view_footer' , true);
                                 if ($keys): ?>
     ...
     * регистрация виджета
     */
     function ym_slick_footer_load() {
         register_widget( 'ym_slick_footer' );
     }

add_action( 'widgets_init', 'ym_slick_footer_load' );